        ...
        token_budget=ProductRunTokenBudget(
            ...
            work_packages=tuple(
                ProductWorkPackageTokenBudget(
                    ...
                    developer_observed_prompt_tokens=item.developer_observed_prompt_tokens,
                    repair_observed_prompt_tokens=item.repair_observed_prompt_tokens,
                    developer_predicted_next_input_tokens=item.developer_predicted_next_input_tokens,
                    repair_predicted_next_input_tokens=item.repair_predicted_next_input_tokens,
                    developer_estimated_executable_turns=item.developer_estimated_executable_turns,
                    repair_estimated_executable_turns=item.repair_estimated_executable_turns,
                    ...
                    last_downstream_available_tokens=item.last_downstream_available_tokens,
                    last_borrowed_tokens=item.last_borrowed_tokens,
                    last_budget_decision=item.last_budget_decision,
                    last_budget_reason=item.last_budget_reason,
                    last_recovery_action=item.last_recovery_action,
                    last_cost_prediction_reason=item.last_cost_prediction_reason,
